    ...
    protected void onDraw(Canvas canvas) {
      ...
      /*  if (button_type == TYPE_CANCEL) {
         ...
         if(button_type == TYPE_CANCEL){
             ...
             mPaint.setStrokeWidth(strokeWidth);
             path.moveTo(center_X +button_size / 6f, center_Y/2f);
             path.lineTo(center_X -button_size*1/ 6f, center_Y);
             path.lineTo(center_X +button_size / 6f, center_Y + button_size /4f);
             //path.close();
             canvas.drawPath(path, mPaint);
