 ...
 */
exports.uploadimage = function(url,imageTag, parameters,filepaths,isoriginal,success,error) {
               exec(success, error, 'request', 'uploadimage', [{"url":url,"imageTag":imageTag, "parameters":parameters,"filePaths":filepaths,"isoriginal":isoriginal}]);
};
